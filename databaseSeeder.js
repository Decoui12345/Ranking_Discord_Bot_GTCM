...
async function seedDatabase() {
    ...
    const users = [
        ...
        // Plat:
                    { username: 'bananaman4786',            userId: '762838922166272010',    rank: '1143694702042947614', position: 1 },
                    { username: 'wompwomp105',              userId: '1059535579332755569',   rank: '1143694702042947614', position: 2 },
                    { username: 'jakethedragon16',          userId: '582347178891018250',    rank: '1143694702042947614', position: 3 },
                    { username: 'hqmatrixmod',              userId: '435591373207371776',    rank: '1143694702042947614', position: 4 },
        // Gold:
                    { username: 'tbone7349',                userId: '704476270376779917',    rank: '1143694702042947614', position: 1 },
                    { username: 'pearson6969.',             userId: '1116149148480180264',   rank: '1143694702042947614', position: 2 },
                    { username: '_ice.king_',               userId: '1264743269796024322',   rank: '1143694702042947614', position: 3 },
                    { username: 'artificial3216',           userId: '567818660127965185',    rank: '1143694702042947614', position: 4 },
                    { username: 'mrs_bean_jay',             userId: '875992509225001020',    rank: '1143694702042947614', position: 5 },
                    { username: 'vexzl_22',                 userId: '577984048341975064',    rank: '1143694702042947614', position: 6 },
                    { username: 'moist_ceiling_fan',        userId: '533822037374795816',    rank: '1143694702042947614', position: 7 },
                    { username: '.unfunnyman.',             userId: '1169791990263726151',   rank: '1143694702042947614', position: 8 },
                    { username: 'kaixdpk123',               userId: '1265834541352882289',   rank: '1143694702042947614', position: 9 },
                    { username: 'perc30cc',                 userId: '1011804941704253500',   rank: '1143694702042947614', position: 10 },

        // Silver: 
                    { username: 'zyler_999',                userId: '1011020470499422288',   rank: '1143694702042947614', position: 1 },
                    { username: 'goldsword245',             userId: '812126765153124422',    rank: '1143694702042947614', position: 2 },
                    { username: 'razorsaurus4735',          userId: '934200728015224833',    rank: '1143694702042947614', position: 3 },
                    { username: 'shlong_w0ng',              userId: '1268270991189082227',   rank: '1143694702042947614', position: 4 },
                    { username: 'hank_him',                 userId: '1173325605773779127',   rank: '1143694702042947614', position: 5 },
                    { username: 'itamemario57',             userId: '1106329606526599209',   rank: '1143694702042947614', position: 6 },
                    { username: 'zach24254',                userId: '849090882019786753',    rank: '1143694702042947614', position: 7 },
                    { username: 'mooseman0239',             userId: '1212206975761514496',   rank: '1143694702042947614', position: 8 },
                    { username: 'russianhati',              userId: '1130543221399887882',   rank: '1143694702042947614', position: 9 },
                    { username: 'sugma_b',                  userId: '600793637764333636',    rank: '1143694702042947614', position: 10 },
                    { username: 'jittrippin0835',           userId: '872655373000146976',    rank: '1143694702042947614', position: 11 },
                    { username: 'applejuice900_31700',      userId: '1208590082789871627',   rank: '1143694702042947614', position: 12 },
                    { username: 'turfhut',                  userId: '931712371993493544',    rank: '1143694702042947614', position: 13 },
                    //{ username: 'galfgalf',               userId: '727691232335102003',    rank: '1143694702042947614', position: 1 },
                    { username: 'lj32wf',                   userId: '761353277077061652',    rank: '1143694702042947614', position: 14 },
                    { username: 'bingus9757',               userId: '699286427304984646',    rank: '1143694702042947614', position: 15 },
                    { username: 'notcole09',                userId: '986351780143202385',    rank: '1143694702042947614', position: 16 },
                    { username: 'thejrbrosyt',              userId: '1067588238929305642',   rank: '1143694702042947614', position: 17 },
                    { username: 'nobody_cares11',           userId: '1038175568224591963',   rank: '1143694702042947614', position: 18 },
                    { username: 'yeaaaaaaah',               userId: '452157471088443392',    rank: '1143694702042947614', position: 19 },
                    { username: 'guy778',                   userId: '1013298286481911854',   rank: '1143694702042947614', position: 20 },
                    { username: 'sky_32t',                  userId: '1197256922538197144',   rank: '1143694702042947614', position: 21 },
                    { username: 'xspectorlax',              userId: '996917369991610368',    rank: '1143694702042947614', position: 22 },
                    { username: 'daddypurple.',             userId: '807261837292339200',    rank: '1143694702042947614', position: 23 },

        // Iron:
                    { username: 'fx4tal',                   userId: '1008413908593279077',   rank: '1143694702042947614', position: 1 },
                    { username: 'dinotiger01',              userId: '775460861350641696',    rank: '1143694702042947614', position: 2 },
                    { username: 'tayson0017',               userId: '1150940226391384264',   rank: '1143694702042947614', position: 3 },
                    { username: 'branch26',                 userId: '557551717915295774',    rank: '1143694702042947614', position: 4 },
                    { username: 'turtleman',                userId: '975040989519564830',    rank: '1143694702042947614', position: 5 },
                    { username: 'quipshard',                userId: '1053387634019418283',   rank: '1143694702042947614', position: 6 },
                    { username: 'smores8244',               userId: '1065091567230124065',   rank: '1143694702042947614', position: 7 },
                    { username: 'jdxbeatbox',               userId: '1090144604063547452',   rank: '1143694702042947614', position: 8 },
                    { username: '_scp173',                  userId: '1025562735141978133',   rank: '1143694702042947614', position: 9 },

        // Copper:
                    { username: 'bigboy214',                userId: '714693544287141960',    rank: '1143694702042947614', position: 1 },
                    { username: 'darkangelblossom.',        userId: '793212392795930664',    rank: '1143694702042947614', position: 2 },
                    //{ username: 'galfgalf',               userId: '727691232335102003',    rank: '1143694702042947614', position: 1 },
                    { username: 'hengar_yt',                userId: '1130388684466831454',   rank: '1143694702042947614', position: 3 },
